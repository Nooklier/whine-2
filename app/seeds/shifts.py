...
def seed_shifts():
    ...
    shift_seed_data = [
        # Employee 1
        Shift(user_id=1, shift_date=generate_random_date(start_date, end_date), shift_start=time(8, 0), shift_end=time(16, 0)),
        Shift(user_id=1, shift_date=generate_random_date(start_date, end_date), shift_start=time(9, 0), shift_end=time(17, 0)),
        Shift(user_id=1, shift_date=generate_random_date(start_date, end_date), shift_start=time(10, 0), shift_end=time(18, 0)),
        Shift(user_id=1, shift_date=generate_random_date(start_date, end_date), shift_start=time(8, 0), shift_end=time(16, 0)),
        Shift(user_id=1, shift_date=generate_random_date(start_date, end_date), shift_start=time(9, 0), shift_end=time(17, 0)),
        Shift(user_id=1, shift_date=generate_random_date(start_date, end_date), shift_start=time(8, 0), shift_end=time(16, 0)),
        Shift(user_id=1, shift_date=generate_random_date(start_date, end_date), shift_start=time(9, 0), shift_end=time(17, 0)),
